  ...
  <section class="text-gray-600 body-font overflow-hidden">
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://imgd.aeplcdn.com/1056x594/cw/ec/26860/Maruti-Suzuki-Dzire-Front-view-105300.jpg?v=201711021421&q=85">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 class="text-sm title-font text-gray-500 tracking-widest">MARUTI SWIFT DESIRE</h2>
          <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">The Catcher in the Rye</h1>
          <div>
          <div class="flex">
            <span class="title-font font-medium text-2xl text-gray-900">Rs.1500/day</span>
